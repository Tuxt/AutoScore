...
parser = argparse.ArgumentParser(description="Test 004 - 2-layer (SimpleRNN/LSTM/GRU) with complete dictionary and padding")
...
weights_dir = 'weights004_' + rnn_layer1 + '-' + str(rnn_units1) + '_' + rnn_layer2 + '-' + str(rnn_units2)
if not os.path.exists(weights_dir):
    os.makedirs(weights_dir)
history_dir = 'history_' + rnn_layer1 + '-' + str(rnn_units1) + '_' + rnn_layer2 + '-' + str(rnn_units2)
...
dm.save(history.history, history_dir + "/test004_loss_acc")
dm.save(callback_metric.train_precisions, history_dir + "/test004_train-precision")
dm.save(callback_metric.val_precisions, history_dir + "/test004_val-precision")
dm.save(callback_metric.train_recalls, history_dir + "/test004_train-recall")
dm.save(callback_metric.val_recalls, history_dir + "/test004_val-recall")
dm.save(callback_metric.train_f1s, history_dir + "/test004_train-fscore")
dm.save(callback_metric.val_f1s, history_dir + "/test004_val-fscore")
